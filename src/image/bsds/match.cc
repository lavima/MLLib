    ...
    Matrix& m1, Matrix& m2)
{
    ...
    // Initialize to zeros. The lines have been commented out to ensure that 
    // the following code operates on the double array sent from SML (Lars Vidar
    // Magnusson <lars.v.magnusson@hiof.no>).
